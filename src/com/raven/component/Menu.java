...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "Laporan Peminjaman", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Laporan Pengembalian", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Daftar Buku", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Daftar Anggota", Model_Menu.MenuType.MENU));
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#2A2E3F"), 0, getHeight(), Color.decode("#2A2E3F"));
        g2.setPaint(g);
        g2.fillRoundRect(0, 0, getWidth(), getHeight(), 90, 75);
        g2.fillRect(getWidth() - 90, 0, getWidth(), getHeight());
